...
<font face="仿宋" color="red" size=3>关键词：单细胞RNA测序；前额叶皮层；神经元；聚类 </font><br><hr>
...
纵观整个生物信息领域的发展史，大致可以分为以下几个阶段。</font><br><hr>
...
![](/static/本科毕业论文综述/MDS处理下的某物种信息.png)<br><br>

<font face="仿宋" size=3>随着颗粒度要求越来越高，MDS对大数据集效果可能会受限，并可能产生一定的失真，尤其针对非线性数据。此时急需一种能够满足生物诸如基因数据量级的分析方法，能够针对非线性数据如基因等数据实现较好的适应性。</font><br><hr>
...
![](/static/本科毕业论文综述/t-SNE在mnist数据集上的降维结果.png)<br><br>
...
![](/static/本科毕业论文综述/社区发现算法Louvain.png)  <br><hr>
...
![](/static/本科毕业论文综述/论文整体框架.png)  <br><hr>
